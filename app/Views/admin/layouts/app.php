  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-petcare sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SiGebang</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/admin/perangkat-desa">Perangkat Desa</a>
            <a class="collapse-item" href="/admin/berita">Berita</a>
            <a class="collapse-item" href="/admin/penduduk">Penduduk</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Pemerinta Desa Gebang</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
